...
def initialize_pretrained_model(model, num_classes, settings):
    ...
    downloaded_state_dict = model_zoo.load_url(settings['url'])
    current_state_dict = model.state_dict()

    for name, param in downloaded_state_dict.items():
...
class se_re(nn.Module):
    def __init__(self):
        super(se_re, self).__init__()
        ...
        print('Loaded pretrained weights for seresnet50')
